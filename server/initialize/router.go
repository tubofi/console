...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		router.InitUserDefinedRouter(PrivateGroup)
		router.InitClassRouter(PrivateGroup)
		router.InitStudentRouter(PrivateGroup)
		router.InitPotentialRouter(PrivateGroup)
		router.InitCourseRouter(PrivateGroup)
		router.InitTrialRouter(PrivateGroup)
		router.InitTeacherRouter(PrivateGroup)
		router.InitBillRouter(PrivateGroup)
