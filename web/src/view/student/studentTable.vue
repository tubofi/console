    ...
    <div>
        <div class="search-term">
            <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
                ...
                <el-form-item label="教师">
                    <el-input v-model="searchInfo.teacherName" placeholder="请输入教师姓名" />
                </el-form-item>
                ...
                <el-form-item label="课次">
                    <el-select v-model.number="searchInfo.courseRemain" clearable placeholder="请选择课次范围">
                        <el-option
                ...
                <el-form-item label="积分">
                    <el-select v-model.number="searchInfo.creditRemain" clearable placeholder="请选择积分范围">
                        <el-option
        ...
        <el-dialog :before-close="closeDialog" :visible.sync="dialogFormVisible" title="新学员表单" width="30%">
            <el-form ref="formData" :model="formData" :rules="rules" label-position="right" label-width="100px">
                ...
                <el-form-item label="报名日期:" prop="entryTime">
                    <template>
                        <el-date-picker
...
<script>
    ...
    const courseRemainOptions = [
        {label: '无', value: 0},
        {label: '小于等于3次', value: 3},
        {label: '大于3小于等于6', value: 6},
        {label: '大于6小于等于16', value: 16},
        {label: '大于16次', value: 17},
    ];
    const creditRemainOptions = [
        {label: '无', value: 0},
        {label: '小于等于50', value: 50},
        {label: '大于50小于等于100', value: 100},
        {label: '大于100小于等于200', value: 200},
        {label: '大于200', value: 201},
    ];
    import {
        createStudent,
        deleteStudent,
    ...
    export default {
        ...
        data() {
            return {
                ...
                courseRemainOptions: courseRemainOptions,
                creditRemainOptions: creditRemainOptions,
                teacherOptions: [],
