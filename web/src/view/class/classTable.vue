...
<template>
    <div>
        ...
        <el-table
            ...
            <el-table-column label="班级ID" prop="ID" align="center" width="100"/>
            ...
            <el-table-column label="时间" prop="timeString" align="center"/>
            ...
            <el-table-column label="按钮组" align="center" width="200">
                <template slot-scope="scope">
                    <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateClass(scope.row)">编辑</el-button>
